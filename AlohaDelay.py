        ...
        def Run(self):
                while True:
                        if self.Flag == 0:
                            ...
                            #print 'This is the arrival Time for', self.ID, now()
                            self.Packets += 1
                            Node.TotalPackets += 1

                            yield request, self, RV.Channel
                            #print 'This is the request Time for', self.ID, now()
                            #print len(RV.Channel.waitQ),self.ID
                            if RV.Channel.waitQ != []:
                                Node.WastedSlots += 1
                                self.Flag = 1
                                print self.ID, self.Flag
                                yield release, self, RV.Channel
                                #print(RV.Channel.activeQ)
                            else:
                                ...
                                yield release, self, RV.Channel
                                #print 'This is the release Time for', self.ID, now()
                            #print len(RV.Channel.waitQ)



                            #print 'This is the hold Time for', self.ID, now()
